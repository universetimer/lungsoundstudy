...
const TRANSLATIONS = {
  ko: {
    ...
    "videos.section.lsl.sub": "universe79 운영 — 호흡음 학습 채널. 채널 홈·영상·Shorts로 바로 이동.",
    "videos.section.lslvids": "Lung Study Lab — 호흡음 영상",
    "videos.section.lslvids.sub": "채널의 호흡음 관련 영상. 영상이 비어 있다면 채널 페이지에서 영상 URL을 공유해 주시면 추가합니다.",
    "videos.section.lslshorts": "Lung Study Lab — Shorts",
    "videos.section.lslshorts.sub": "60초 이내 짧은 호흡음 클립.",
    "videos.lsl.channel": "채널 홈",
    "videos.lsl.videos": "전체 영상",
    "videos.lsl.shorts": "Shorts",
    "videos.empty.add": "이 섹션을 채우려면 영상 URL을 알려 주세요. 예: https://www.youtube.com/watch?v=XXXXXXXXXXX · https://www.youtube.com/shorts/XXXXXXXXXXX",
  ...
  en: {
    ...
    "videos.section.lsl": "Lung Study Lab",
    "videos.section.lsl.sub": "Channel run by universe79 — lung sound learning. Jump directly to the channel home, videos or Shorts.",
    "videos.section.lslvids": "Lung Study Lab — videos",
    "videos.section.lslvids.sub": "Lung sound videos from the channel. If empty, share a video URL from the channel and it will be added.",
    "videos.section.lslshorts": "Lung Study Lab — Shorts",
    "videos.section.lslshorts.sub": "Sub-minute lung sound clips.",
    "videos.lsl.channel": "Channel home",
    "videos.lsl.videos": "All videos",
    "videos.lsl.shorts": "Shorts",
    "videos.empty.add": "Share a video URL to fill this section. e.g. https://www.youtube.com/watch?v=XXXXXXXXXXX · https://www.youtube.com/shorts/XXXXXXXXXXX",
